        ...
        if (remoteMessage.getData().size() > 0) {
            ...
            switch (data.get(DESTINATION_TYPE)) {
                case DESTINATION_ACTIVITY:
                    ...
                    switch (activity) {
                        case ACTIVITY_MAIN :
                            ...
                            showActivityMain.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                            sendNotification(remoteMessage.getNotification().getBody(), showActivityMain);
                            break;

                        case ACTIVITY_POST :
                            Intent showActivityPost = new Intent(this, GoogleNewsActivity.class);
                            showActivityPost.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                            sendNotification(remoteMessage.getNotification().getBody(), showActivityPost);
                            // TODO: 5/1/2019 Which post has to show
                            break;
                    }
                    break;
                ...
                case DESTINATION_URL:
                    ...
                    Intent showWebPageURL = new Intent(Intent.ACTION_VIEW, Uri.parse(url));
                    showWebPageURL.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    sendNotification(remoteMessage.getNotification().getBody(), Intent.createChooser(showWebPageURL, "Choose Your Browser"));
                    break;
            }
    ...
    private void sendNotification(String messageBody, Intent intent) {
        ...
        NotificationCompat.Builder notificationBuilder =
                new NotificationCompat.Builder(this)
                        .setSmallIcon(R.drawable.be_aware_logo)
                        .setLargeIcon(BitmapFactory.decodeResource(getResources(), R.mipmap.be_aware_logo))
